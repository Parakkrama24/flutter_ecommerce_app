...
class AppData {
  ...
  static String description =
      ...
      "The Nike Air Max 90 stays true to its OG running roots with the iconic Waffle sole, stitched overlays, "
      "and classic TPU details. Classic colors celebrate your fresh look while Max Air cushioning adds comfort to the journey.";
}
